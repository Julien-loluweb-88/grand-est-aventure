    ...
    <div className="mx-auto w-full max-w-3xl flex-1 py-4 sm:py-6">
      <article className="bg-[#fffaeb] p-6 shadow-sm sm:p-10">
        ...
        <p className="mt-3 text-sm text-[#281401]/80 sm:text-base">
          ...
          <strong className="font-semibold">Balad&apos;indice</strong> (parcours,
          comptes joueurs, avis, administration le cas échéant), dans le respect
          du Règlement (UE) 2016/679 (RGPD) et de la loi « Informatique et libertés ».
        </p>
        ...
        <LegalSection id="collecte" title="2. Données collectées et finalités">
          ...
          <ul className="ms-4 list-inside list-disc space-y-2 marker:text-[#68a618]">
            <li>
              <strong className="font-semibold">Compte et authentification</strong> : identifiant, adresse e-mail, mot de passe (haché côté serveur), données de
              session / jetons, et le cas échéant informations fournies par un
              fournisseur de connexion tiers (Google, Facebook, Discord, etc.) si ces
              options sont activées — <em>fourniture du service et sécurité</em>.
            </li>
            <li>
              <strong className="font-semibold">Activité de jeu</strong> :
              progression sur les parcours, validations d&apos;énigmes et d&apos;étapes
              trésor, attributions de badges ou équivalents —{' '}
              <em>exécution du service et statistiques d&apos;usage agrégées</em>.
            </li>
            <li>
              <strong className="font-semibold">Avis et contenus</strong> : texte et
              éventuellement photographies transmis en fin de parcours —{' '}
              <em>gestion des retours utilisateurs et modération</em>.
            </li>
            <li>
              <strong className="font-semibold">Géolocalisation</strong> : si vous
              autorisez la localisation sur l&apos;appareil, elle peut servir à
              proposer des parcours à proximité —{' '}
              <em>uniquement avec consentement explicite lorsque requis</em>.
            </li>
            <li>
              <strong className="font-semibold">Publicités</strong> : données
              techniques ou d&apos;événements nécessaires au bon affichage et à la
              mesure d&apos;audience / lutte contre la fraude, selon la mise en
              œuvre effective du service.
            </li>
            <li>
              <strong className="font-semibold">Journaux et maintenance</strong> :
        ...
        <LegalSection id="destinataires" title="4. Destinataires et sous-traitants">
          <p>
            ...
            Better Auth), l&apos;envoi d&apos;e-mails, l&apos;hébergement de
            fichiers ou cartes, à des prestataires techniques strictement nécessaires,
            liés par des obligations contractuelles (confidentialité, RGPD). Une
            liste actualisée des principaux sous-traitants peut être fournie sur
            demande.
          </p>
        </LegalSection>
        ...
        <LegalSection id="durees" title="6. Durées de conservation">
          <p>
            ...
            d&apos;utilisation du service et un délai raisonnable après
            clôture du compte ou d&apos;inactivité prolongée (sauf obligations
            légales de conservation plus longues). Les logs techniques sont
            conservés pour une durée limitée compatible avec la sécurité et la
            défense en justice.
          </p>
        </LegalSection>
        ...
        <LegalSection id="droits" title="7. Vos droits">
          <p>
            ...
            de limitation, de portabilité (lorsqu&apos;il s&apos;applique), et
            d&apos;opposition pour les traitements fondés sur l&apos;intérêt
            légitime, ainsi que du droit de retirer votre consentement à tout
            moment lorsque le traitement en dépend. Vous pouvez introduire une
        ...
        <p className="mt-10 border-t border-[#281401]/15 pt-6 text-sm text-[#281401]/75">
          ...
          <Link href="/cgu" className="underline underline-offset-2 hover:no-underline">
