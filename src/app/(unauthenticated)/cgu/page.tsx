...
export default function CguPage() {
  return (
    <LegalPageShell
      ...
      lead={
        <p>
          Dernière mise à jour : 1er avril 2026. Les présentes conditions régissent
          l&apos;utilisation du site et du service numérique
          <strong className="font-semibold text-[#281401]"> Balad&apos;indice</strong>{" "}
          (application mobile et/ou interface web associée, et API de jeu), proposé
          dans le cadre de parcours de type chasse au trésor, énigmes et balades
          (dont dans l&apos;espace public).
        </p>
      }
    >
      <LegalTableOfContents>
        ...
        <LegalTocItem href="#securite">
          Activités extérieures et sécurité
        </LegalTocItem>
        <LegalTocItem href="#publicite">Publicités</LegalTocItem>
        <LegalTocItem href="#disponibilite">
      ...
      <div className="mt-8 space-y-12 sm:mt-10">
        <LegalSection id="objet" title="1. Objet et acceptation">
          <p>
            ...
            <strong className="font-semibold text-[#281401]">CGU</strong> ») ont pour
            objet de définir les modalités d&apos;accès et d&apos;utilisation du
            service Balad&apos;indice. En créant un compte, en vous connectant, ou en
            utilisant toute fonctionnalité du service (parcours, validation
            d&apos;énigmes, avis, affichage de contenus), vous acceptez sans réserve
            les présentes CGU. Si vous n&apos;acceptez pas ces conditions, vous ne
        ...
        <LegalSection id="service" title="2. Description du service">
          <p>
            ...
            réservé aux personnes habilitées pour la création et la gestion des
            contenus.
          </p>
          <p>
        ...
        <LegalSection id="compte" title="3. Compte et accès">
          <p>
            ...
            et une authentification sécurisée (par exemple adresse e-mail et mot de
            passe, ou fournisseurs tiers si activés). Vous vous engagez à fournir des
            informations exactes et à maintenir la confidentialité de vos
            identifiants. Toute activité réalisée depuis votre compte est présumée
            effectuée par vous, sauf preuve d&apos;une utilisation frauduleuse que
            vous avez signalée sans délai.
          </p>
          <p>
            L&apos;accès au tableau de bord d&apos;administration et aux outils de
            gestion des parcours est réservé aux comptes explicitement autorisés par
            l&apos;éditeur ou ses partenaires. Toute tentative d&apos;accès non
            autorisé est interdite et peut faire l&apos;objet de mesures techniques,
            juridiques ou de signalement aux autorités.
          </p>
        </LegalSection>
        ...
        <LegalSection id="regles" title="4. Règles d’utilisation">
          ...
          <LegalList>
            ...
            <li>
              ...
              données ou du contenu réservé aux joueurs, ni d&apos;attaquer le service
              (intrusion, saturation, etc.) ;
            </li>
            <li>
              ne pas publier ou transmettre de contenus illicites, haineux,
              diffamatoires, à caractère pornographique ou portant atteinte à la vie
              privée d&apos;autrui ;
            </li>
            <li>
          ...
          <p>
            ...
            grave ou répété aux présentes CGU, après notification lorsque cela est
        ...
        <LegalSection id="contenus" title="5. Contenus des utilisateurs">
          <p>
            ...
            (texte, image) en fin de parcours ou dans d&apos;autres contextes prévus
            par l&apos;application. Vous garantissez disposer des droits nécessaires
            sur ce que vous transmettez et que ces contenus sont conformes à la loi.
          </p>
          <p>
            Concédant une licence non exclusive, mondiale et gratuite, vous autorisez
            l&apos;éditeur à héberger, reproduire, afficher et adapter ces contenus
            dans la mesure strictement nécessaire au fonctionnement et à la promotion
            du service (affichage dans l&apos;app, modération, statistiques
            anonymisées). Vous restez propriétaire de vos contenus, sous réserve des
            droits des tiers.
          </p>
          <p>
            L&apos;éditeur peut modérer, retirer ou refuser tout contenu contraire aux
            CGU ou à la loi, sans obligation de surveillance préalable.
          </p>
        </LegalSection>
        ...
        <LegalSection id="propriete" title="6. Propriété intellectuelle">
          <p>
            ...
            visuels, bases de données et logiciels mis à disposition par l&apos;éditeur
            sont protégés. Toute reproduction, représentation ou extraction non
            autorisée est interdite, sauf exceptions légales (copies privées,
            citation, etc.).
          </p>
          <p>
            ...
            utilisation reste limitée à une utilisation personnelle dans le cadre du
            jeu, sans revente ni réutilisation commerciale sauf accord écrit.
          </p>
        </LegalSection>
        ...
        <LegalSection id="donnees" title="7. Données personnelles">
          <p>
            ...
            limitation, portabilité), contactez l&apos;éditeur via les coordonnées
            prévues aux{" "}
            <Link href="/mentions-legales" className={legalLinkClass}>
              mentions légales
            </Link>{" "}
        ...
        <LegalSection id="securite" title="8. Activités extérieures et sécurité">
          <p>
            ...
            propre appréciation et de votre capacité physique. Vous devez respecter le
            code de la route et les règles de sécurité, surveiller les mineurs dont
            vous avez la charge, et adapter votre comportement aux conditions
            météorologiques et de visibilité.
          </p>
          <p>
            L&apos;éditeur ne peut garantir l&apos;absence de risque sur les lieux ni
            l&apos;exactitude permanente des indications terrain (travaux, fermetures,
            déplacement d&apos;objets). Signalez tout incident ou contenu inadapté via
            les canaux prévus par l&apos;application ou le site.
          </p>
        </LegalSection>
        ...
        <LegalSection id="publicite" title="9. Publicités">
          <p>
            ...
            partenaires (publicités), dans des emplacements prévus par l&apos;interface,
            sans que ceux-ci remplacent les obligations de prudence et de respect
            de la vie privée décrites dans la politique de confidentialité. Le cas
            échéant, des événements liés aux publicités peuvent être enregistrés pour
            des finalités de mesure et de fraude ; le détail figure dans les
            informations sur les cookies et traceurs lorsqu&apos;elles sont publiées.
          </p>
        </LegalSection>
        ...
        <LegalSection id="disponibilite" title="10. Disponibilité et évolutions">
          <p>
            ...
            d&apos;interruption (maintenance, mise à jour, cas de force majeure,
            défaillance d&apos;un prestataire). Les fonctionnalités, parcours et règles
            de jeu peuvent évoluer ; en cas de changement substantiel des CGU, une
            information sur le site ou dans l&apos;application pourra vous être
            proposée avant ou au moment de la reprise d&apos;utilisation.
          </p>
        </LegalSection>
        ...
        <LegalSection id="responsabilite" title="11. Responsabilité">
          <p>
            ...
            étant directement imputable et, pour les dommages indirects ou
            immatériels non prévus par la loi impérative, dans le cadre restreint
            fixé par les textes applicables. Les montants pouvant être dus au titre du
            service gratuit ou à titre de réparation seront, le cas échéant,
          ...
          <p>
            ...
            n&apos;est pas tenu d&apos;offrir une récompense matérielle si le parcours
            ou l&apos;offre le précise clairement.
          </p>
        </LegalSection>
        ...
        <LegalSection id="modifications" title="12. Modifications des CGU">
          <p>
            ...
            ou des obligations légales. La date de « dernière mise à jour » en tête de
            page est modifiée en conséquence. La poursuite d&apos;utilisation du
            service après publication vaut acceptation des CGU en vigueur, sauf
            disposition impérative contraire vous conférant un droit de refus ou de
            résiliation.
          </p>
        </LegalSection>
        ...
        <LegalSection id="droit" title="13. Droit applicable et litiges">
          <p>
            ...
            cas de litige, et à défaut de résolution amiable dans un délai raisonnable,
            les tribunaux français seront compétents, sous réserve des règles
            d&apos;ordre public applicables aux consommateurs (notamment leur droit
            d&apos;introduire une action devant le tribunal de leur résidence ou de
            recourir à une médiation ou à la plateforme européenne de règlement en
            ligne des litiges lorsque ces dispositifs s&apos;appliquent).
          </p>
        </LegalSection>
      </div>

      <LegalFooterNote>
        Pour toute question sur ces conditions, utilisez le lien « Contact » du pied
        de page du site public lorsqu&apos;il est actif, ou l&apos;adresse indiquée
