...
import { updateAdventure } from "./update-adventure.action";
...
export function AdventureEditForm({
  ...
  const handleFormSubmit = (e: FormEvent<HTMLFormElement>) => {
    void form.handleSubmit(onSubmit, () => {
      toast.error(
        "Vérifie les champs du formulaire (description, coordonnées, etc.)."
      );
    })(e);
  };
                                ...
                                <LocationPicker
                                  ...
                                  helperText={
                                    ...
                                    (adventure.routePolyline &&
                                      ...
                                      ? `Trait bleu : itinéraire OpenRouteService. Marqueurs : départ (déplaçable), énigmes, trésor (T).${
                                          routePreviewLoading
                                            ? " Recalcul en cours…"
                                            : ""
                                        }`
                                      : `Configurez OPENROUTESERVICE_API_KEY et ayez au moins deux étapes pour le tracé.${
                                          routePreviewLoading
                                            ? " Recalcul en cours…"
                                            : ""
                                        }`
